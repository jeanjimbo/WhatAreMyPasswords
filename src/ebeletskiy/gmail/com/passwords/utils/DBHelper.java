...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public Cursor getItem(int id) {
        return (getReadableDatabase().rawQuery("SELECT _id, " + COLUMN_NAME_TITLE + ", "
                + COLUMN_NAME_LOGIN + ", " + COLUMN_NAME_PASSWORD + ", " + COLUMN_NAME_NOTES
                + " FROM " + TABLE_NAME + " WHERE _id = " + id, null)); // TODO:
                                                                        // updated
                                                                        // 'title'
    }
    ...
    public Cursor getItemByTitle(String str) {
        ...
        return (getReadableDatabase().rawQuery("SELECT *" + " FROM " + TABLE_NAME + " WHERE "
                + COLUMN_NAME_TITLE + " = " + tmpStr, null));
    }
