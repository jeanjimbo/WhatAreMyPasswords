...
public class DBHelper extends SQLiteOpenHelper
{
  ...
  private static final String CREATE_DATABASE = "CREATE TABLE " + TABLE_NAME
      + "(_id INTEGER PRIMARY KEY AUTOINCREMENT," + COLUMN_NAME_TITLE
      + " TEXT, " + COLUMN_NAME_LOGIN + " TEXT, " + COLUMN_NAME_PASSWORD
      + " TEXT, " + COLUMN_NAME_NOTES + " TEXT);";
  ...
  public Cursor getAll() {
    return (getReadableDatabase().rawQuery("SELECT _id, " + COLUMN_NAME_TITLE
        + ", " + COLUMN_NAME_LOGIN + ", " + COLUMN_NAME_PASSWORD + ", "
        + COLUMN_NAME_NOTES + " FROM " + TABLE_NAME, null)); // TODO: updated
                                                             // 'title'
  }
  ...
  public void updateRow(Ticket ticket) {
    ...
    getWritableDatabase().update(TABLE_NAME, cv, "_id=?",
        new String[] { Integer.toString(ticket.getId()) });
  ...
  public Cursor getItem(int id) {
    return (getReadableDatabase().rawQuery("SELECT _id, " + COLUMN_NAME_TITLE
        + ", " + COLUMN_NAME_LOGIN + ", " + COLUMN_NAME_PASSWORD + ", "
        + COLUMN_NAME_NOTES + " FROM " + TABLE_NAME + " WHERE _id = " + id,
        null)); // TODO: updated 'title'
  }
  ...
  public Cursor getItemByTitle(String str) {
    String tmpStr = DatabaseUtils.sqlEscapeString(str);
    return (getReadableDatabase().rawQuery("SELECT *" + " FROM " + TABLE_NAME
        + " WHERE " + COLUMN_NAME_TITLE + " = " + tmpStr, null));
  }
